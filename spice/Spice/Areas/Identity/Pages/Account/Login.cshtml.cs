    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    // this user object allows us to check the users shopping cart
                    ...
                    // put the number of items in the cart in the session (how you assign the session on the login page)
