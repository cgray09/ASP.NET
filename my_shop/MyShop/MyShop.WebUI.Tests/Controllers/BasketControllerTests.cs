...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanGetSummaryViewModel() {
            ...
            Assert.AreEqual(3, basketSummary.BasketCount); // from the quanity total
                                                           // added above
        ...
        public void CanCheckoutAndCreateOrder() {
            ...
            Assert.AreEqual(0, basket.BasketItems.Count); // since we clear the basket
                                                          // after we create an order

            Order orderInRep = orders.Find(order.Id);
            Assert.AreEqual(2, orderInRep.OrderItems.Count); // checking if we have
                                                             // 2 orders in the 
                                                             // repository itself
