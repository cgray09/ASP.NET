...
namespace Uplift.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult AddToCart(int serviceId)
        {
            ...
            if (string.IsNullOrEmpty(HttpContext.Session.GetString(SD.SessionCart))) // GetString is built in
            {
                sessionList.Add(serviceId);
                HttpContext.Session.SetObject(SD.SessionCart, sessionList); // SetObject is from Extensions folder
            }
            else
            {
